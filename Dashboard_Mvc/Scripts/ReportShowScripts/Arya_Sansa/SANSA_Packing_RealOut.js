//# sourceURL=SANSA_Packing_RealOut.js
var getRealOutUrl = "../FoxlinkSfc/getPackTotalCapacity", modelNO = "Sansa", isTotalCapacity = false;
if (timeInterval == "1Week") {
    var RealOutChart = new Object();
    RealOutChart.RenderTO = 'divProductArea';
    RealOutChart.Title = 'Sansa近七天包裝站實際產出';
    RealOutChart.yAxisTitle = 'Sansa近七天包裝站實際產出';
    RealOutChart.xtext = [];
    var chartSeries = [{
        type: 'column',
        name: "Sansa近七天包裝站實際產出"
    },
                       {
                           type: 'line',
                           name: "Sansa近七天包裝站實際產出",
    ...
    RealOutRateChart.Title = 'Sansa近七天包裝站實際產出良率';
    RealOutRateChart.yAxisTitle = 'Sansa近七天包裝站實際產出良率';
    RealOutRateChart.xtext = [];
    var chartSeries = [{
        type: 'line',
        name: "Sansa近七天包裝站實際產出良率",
        tooltip: {
            valueSuffix: '%'
        }
    }
...
if (timeInterval == "2Week") {
    var RealOutChart = new Object();
    RealOutChart.RenderTO = 'divProductArea';
    RealOutChart.Title = 'Sansa近兩周包裝站實際產出';
    RealOutChart.yAxisTitle = 'Sansa近兩周包裝站實際產出';
    RealOutChart.xtext = [];
    var chartSeries = [{
        type: 'column',
        name: "Sansa近兩周包裝站實際產出"
    },
                       {
                           type: 'line',
                           name: "Sansa近兩周包裝站實際產出",
    ...
    var RealOutRateChart = new Object();
    RealOutRateChart.RenderTO = 'divRateArea';
    RealOutRateChart.Title = 'Sansa近兩周包裝站實際產出良率';
    RealOutRateChart.yAxisTitle = 'Sansa近兩周包裝站實際產出良率';
    RealOutRateChart.xtext = [];
    var chartSeries = [{
        type: 'line',
        name: "Sansa近兩周包裝站實際產出良率",
        tooltip: {
            valueSuffix: '%'
        }
    }
...
if (timeInterval == "1Month") {
    var RealOutChart = new Object();
    RealOutChart.RenderTO = 'divProductArea';
    RealOutChart.Title = 'Sansa近一個月包裝站實際產出';
    RealOutChart.yAxisTitle = 'Sansa近一個月包裝站實際產出';
    RealOutChart.xtext = [];
    var chartSeries = [{
        type: 'column',
        name: "Sansa近一個月包裝站實際產出"
    },
                       {
                           type: 'line',
                           name: "Sansa近一個月包裝站實際產出",
    ...
    var RealOutRateChart = new Object();
    RealOutRateChart.RenderTO = 'divRateArea';
    RealOutRateChart.Title = 'Sansa近一個月包裝站實際產出良率';
    RealOutRateChart.yAxisTitle = 'Sansa近一個月包裝站實際產出良率';
    RealOutRateChart.xtext = [];
    var chartSeries = [{
        type: 'line',
        name: "Sansa近一個月包裝站實際產出良率",
        tooltip: {
            valueSuffix: '%'
        }
    }
...
if (timeInterval == "4Month") {
    ...
    totalProductChart.Title = 'Sansa近四月總產量';
    totalProductChart.yAxisTitle = 'Sansa近四月總產量';
    ...
    productRateChart.Title = 'Sansa近四月總產量良率';
    productRateChart.yAxisTitle = 'Sansa近四月總產量良率';
